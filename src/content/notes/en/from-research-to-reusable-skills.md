---
title: "From one study to a reusable skill: retaining the professional method"
...
This needs [knowledge that a team can find, update, and use](../knowledge-engineering-is-not-a-build/). One task becomes a method, and the method returns to the next task. That is how I want experience to accumulate.
